 ...
 *   dense   — 5–6 rows or 5+ cards (Solution, Mechanism, Trust, Live)
 ...
 *
 * (Pass-3 added a 'comfortable' tier with MORE top padding for Live;
 * Pass 4A discovered Live was overflowing and switched it to 'dense',
 * which left 'comfortable' unused. Removed in Pass 4B.)
 */
